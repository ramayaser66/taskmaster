...
public final class Task implements Model {
  ...
  public interface DescriptionStep {
    StatusStep description(String description);
  }
  ...
  public static class Builder implements TitleStep, DescriptionStep, StatusStep, BuildStep {
    private String id;
    ...
    @Override
     public StatusStep description(String description) {
